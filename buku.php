...
// $totalData = count(query("SELECT * FROM daftar_buku"));
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<form action="" method="post" enctype="multipart/form-data">
									...
									<input type="text" class="form-control" name="terbit" id="terbit">

									<label for="kategori">Kategori</label>
									<input type="text" class="form-control" name="kategori" id="kategori">

									<label for="jumlah" style="padding-top: 8px;">Jumlah Buku</label>
							...
							<table class="table table-hover">
								<thead class="thead-dark" style="background-color: #023047; color: #ffffff;">
									<tr>
										...
										<th class="ctr align-middle">KODE BUKU</th>
										...
										<th class="ctr align-middle">JUMLAH BUKU</th>
									...
									<tbody>
										<tr>
											...
											<td class="text-center align-middle">
												...
												<button style="margin-right: 0px; margin-bottom: 5px;" type="submit"
												...
												<a class="btn btn-danger btn-sm" name="hapus"
													href="hapus.php?id=<?= $row["id"]; ?>"><i class="fa fa-trash"></i>
													HAPUS</a>
													...
													<div class="modal-body">
														<form action="" method="post" enctype="multipart/form-data">
															...
															<input type="text" class="form-control" name="pengarang"
																id="pengarang" value="<?= $row["pengarang"]; ?>">

															<label for="terbit">Tahun Terbit</label>
															<input type="text" class="form-control" name="terbit"
																id="terbit" value="<?= $row["terbit"]; ?>">

															<label for="kategori">Kategori</label>
															<input type="text" class="form-control" name="kategori"
																id="kategori" value="<?= $row["kategori"]; ?>">

															<label for="jumlah" style="padding-top: 8px;">Jumlah
																Buku</label>
															<input type="text" class="form-control" name="jumlah"
																id="jumlah" value="<?= $row["jumlah_buku"]; ?>">
